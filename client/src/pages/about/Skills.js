...
function Skills(props) {
	...
	return (
      ...
      <div style={{marginLeft:"40px"}}>
			<h3 style={{ color: selectedColor }}> My Toolbox and Things I Can Do </h3>
			<p>
				{" "}
			...
			<table style={{border:"none"}}>
				<tbody>
					<tr>
						...
						<td className="section-skill-tools" style={{ paddingTop: "40px" }}>
              <div style={{ display: "flex" }}>
							<span style={{ color: selectedColor, fontSize: "1.2rem", paddingTop:"30px" }}>
								Express
							</span>
							<SiJavascript
								color={selectedColor}
            ...
            <td className="section-skill-tools">
					...
					<tr style={{ marginTop: "180px" }}>
						...
						<td className="section-skill-tools">
							...
							/>
							<p className="name" style={{paddingLeft: "0px"}}>JavaScript</p>
						</td>
						<td className="section-skill-tools">
							<SiJquery
								color={selectedColor}
            ...
            <td className="section-skill-tools">
							<CgCPlusPlus
								...
								style={{ width: "80px", height: "80px" }}
							/>
							<p className="name" style={{paddingLeft: "0px"}}>C++</p>
						</td>
					</tr>
