	...
	return (
		<div>
			<ColorPickerView>
				...
				<ColorPallete
					color="#33B18A"
					onClick={() => chooseColor("#33B18A", "green")}
				>
					{visiblityCheck.green ? <CheckIcon style={checkIconStyling} /> : null}
				</ColorPallete>
				<ColorPallete
					color="#FF013D"
					onClick={() => chooseColor("#FF013D", "red")}
				>
					{visiblityCheck.red ? <CheckIcon style={checkIconStyling} /> : null}
				</ColorPallete>
				<ColorPallete
					color="#ffb135"
					onClick={() => chooseColor("#ffb135", "yellow")}
				>
					{visiblityCheck.yellow ? (
						<CheckIcon style={checkIconStyling} />
					) : null}
				</ColorPallete>
				<ColorPallete
					color="#51a5c4"
					onClick={() => chooseColor("#51a5c4", "blue")}
				>
					{visiblityCheck.blue ? <CheckIcon style={checkIconStyling} /> : null}
				</ColorPallete>
				<ColorPallete
					color="#dc4970"
					onClick={() => chooseColor("#dc4970", "pink")}
				>
					{visiblityCheck.pink ? <CheckIcon style={checkIconStyling} /> : null}
				</ColorPallete>
				<ColorPallete
					color="#5D5EB4"
					onClick={() => chooseColor("#5D5EB4", "purple")}
				>
					{visiblityCheck.purple ? (
						<CheckIcon style={checkIconStyling} />
					) : null}
				</ColorPallete>
				{/* <ColorPallete >
